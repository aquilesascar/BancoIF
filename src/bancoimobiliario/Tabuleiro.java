...
public class Tabuleiro {
    ...
    public Tabuleiro() {
        ...
        this.posicoes[1] = new Lote(80, "Leblon", 8);
        //this.posicoes[2] = new Sortereves();
        this.posicoes[3] = new Lote(80, "Av. Presidente Vargas", 6);
        this.posicoes[4] = new Lote(80, "Av. Nossa Senhora de Copacabana", 7);
        this.posicoes[5] = new Companhia(200, "Companhia Ferroviaria", 50);
        this.posicoes[6] = new Lote(110, "Av. Brigadeiro Faria Lima", 13);
        ...
        this.posicoes[14] = new Lote(100, "Avenida Pacaembu", 10);
        ...
        this.posicoes[26] = new Lote(110, "Av. Brasil", 13);
        ...
        this.posicoes[34] = new Lote(170, "Av. Atlantica", 23);
        this.posicoes[35] = new Companhia(200, "Companhia de Taxi Aereo", 50);
        this.posicoes[36] = new Lote(170, "Ipanema", 22);
        //this.posicoes[37] = new Sortereves();
        this.posicoes[38] = new Lote(190, "Jardim Paulista", 28);
        this.posicoes[39] = new Lote(190, "Brooklin", 22);
